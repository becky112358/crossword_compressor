...
fn test_check_different_direction() {
    assert!(check_different_direction(
        0,
        8,
        3,
        "different",
...
fn test_compare_crosswords() {
    ...
    assert_eq!(
        Comparison::First,
        compare_crosswords(&crossword_good0, &best_crosswords)
    );
    assert_eq!(
        Comparison::First,
        compare_crosswords(&crossword_good1, &best_crosswords)
    );
    assert_eq!(
        Comparison::First,
        compare_crosswords(&crossword_bad, &best_crosswords)
    );
...
fn test_is_duplicate() {
    ...
    crossword0.words[2].cross = Some(CrossData {
        row: -3,
        start_point: 4,
        direction: Direction::Down,
        order: 2,
    ...
    best_crosswords[0].words[1].cross = Some(CrossData {
        row: -2,
        start_point: 2,
        direction: Direction::Down,
        order: 2,
    });
    best_crosswords[0].words[2].cross = Some(CrossData {
        row: -3,
        start_point: 4,
        direction: Direction::Down,
        order: 1,
    });
    best_crosswords[0].words[3].cross = Some(CrossData {
        row: 2,
        start_point: 2,
        direction: Direction::Across,
        order: 3,
